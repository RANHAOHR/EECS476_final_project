...
#include <mobot_pub_des_state/emptyQueue.h>
#include <std_msgs/Float64.h>
...
private:
    ...
    ros::ServiceServer empty_queue_;
    ...
    bool emptyQueueCB(mobot_pub_des_state::emptyQueueRequest& request, mobot_pub_des_state::emptyQueueResponse& response);
