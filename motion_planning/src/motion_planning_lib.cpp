...
MotionPlanning::MotionPlanning(ros::NodeHandle* nodehandle): nh_(*nodehandle),
cart_move_action_client_("cartMoveActionServer", true) { // constructor
    ROS_INFO("in constructor of MotionPlanning");
...
void MotionPlanning::doneCb_(const actionlib::SimpleClientGoalState& state,
...
Eigen::Affine3d MotionPlanning::transformPoseToEigenAffine3d(geometry_msgs::Pose pose) {
...
void MotionPlanning::send_test_goal(void) {
    ROS_INFO("sending a test goal");
    cart_goal_.command_code = cwru_action::cwru_baxter_cart_moveGoal::ARM_TEST_MODE;
    cart_move_action_client_.sendGoal(cart_goal_, boost::bind(&MotionPlanning::doneCb_, this, _1, _2)); // we could also name additional callback functions here, if desired
...
int MotionPlanning::plan_move_to_pre_pose(void) {
...
int MotionPlanning::rt_arm_plan_jspace_path_current_to_qgoal(Eigen::VectorXd q_des_vec) {    
    ROS_INFO("requesting a joint-space motion plan");
...
int MotionPlanning::rt_arm_plan_path_current_to_goal_pose(geometry_msgs::PoseStamped des_pose) {
...
int MotionPlanning::rt_arm_plan_path_current_to_goal_dp_xyz(Eigen::Vector3d dp_displacement) {
...
int MotionPlanning::rt_arm_execute_planned_path(void) {
...
int MotionPlanning::rt_arm_request_q_data(void) {
...
Eigen::VectorXd MotionPlanning::get_right_arm_joint_angles(void) {
...
int MotionPlanning::rt_arm_request_tool_pose_wrt_torso(void) {
