...
void PclUtils::seek_coke_can_cloud( pcl::PointCloud<pcl::PointXYZRGB>::Ptr input_cloud_ptr, pcl::PointCloud<pcl::PointXYZRGB>::Ptr &coke_can_pts, Eigen::Vector3f &goal_points )
{
    ...
    goal_points[0] = centroid_[0];
    goal_points[1] = centroid_[1];
    goal_points[2] = centroid_[2];
